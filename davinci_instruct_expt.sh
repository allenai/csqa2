...
echo "EXPT: 10-KNN"
python baselines/gpt3.py --train_file ${DATA_DIR}/CSQA2_5_7_2021_train.json --test_file ${DATA_DIR}/CSQA2_5_7_2021_dev.json --output_file ${DATA_DIR}/${ENGINE}/gpt3-5nn-${SEED}.json --num_few_shot_examples_per_group 10 --num_generations 1 --few_shot_strategy knn --do_eval --sample ${SAMPLE_SIZE} --seed ${SEED} --gpt3_version ${ENGINE}

echo "EXPT: 10-Random"
python baselines/gpt3.py --train_file ${DATA_DIR}/CSQA2_5_7_2021_train.json --test_file ${DATA_DIR}/CSQA2_5_7_2021_dev.json --output_file ${DATA_DIR}/${ENGINE}/gpt3-5random-${SEED}.json --num_few_shot_examples_per_group 10 --num_generations 1 --few_shot_strategy random --do_eval --sample ${SAMPLE_SIZE} --seed ${SEED} --gpt3_version ${ENGINE}
...
echo "EXPT: 5Random-Pair-For-Target-Relation"
